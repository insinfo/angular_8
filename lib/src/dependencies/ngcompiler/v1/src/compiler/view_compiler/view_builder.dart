...
import 'package:ngdart/src/dependencies/ngcompiler/v1/src/compiler/semantic_analysis/binding_converter.dart'
    show
        ...
        convertToBinding;
import 'package:ngdart/src/dependencies/ngcompiler/v1/src/compiler/template_ast.dart';
import 'package:ngdart/src/dependencies/ngcompiler/v1/src/compiler/view_compiler/bound_value_converter.dart';
import 'package:ngdart/src/dependencies/ngcompiler/v1/src/compiler/view_compiler/update_statement_visitor.dart';
...
class ViewBuilderVisitor implements TemplateAstVisitor<void, CompileElement> {
  ...
  void _visitComponentElement(
    ...
    _view.shimCssForNode(elementRef, nodeIndex, Identifiers.htmlElement);
...
o.Constructor _createComponentViewConstructor(CompileView view) {
  ...
  final createRootElementExpr = o
      .importExpr(Identifiers.document)
